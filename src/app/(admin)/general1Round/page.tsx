      ...
      <div className='flex flex-col w-[65%]'>
        <div className='ml-[111%] w-11 pt-7'>
          <div className='flex flex-row  pt-2  '>
           ...
           <div className='flex text-white pt-11 pb-4 text-3xl pl-[28%]'><label>Question 1:</label><input type='text' className=' rounded-md ml-2 text-md text-black'></input></div>
           <div className=' flex text-white text-3xl pl-[29.5%] pt-5'> <label> Answer 1:</label><input type='text'className=' rounded-md w-[15%]  text-md text-black ml-2 '></input></div>
