  ...
  return (
    ...
    <div className="flex flex-row h-full">
      <div className="w-[70%] ml-24 mt-8 ">
        ...
        <div className="text-2xl lg:text-4xl p-3 font-italiana"> Questions (number) :</div>
        <div className="text-2xl lg:text-4xl pl-9 font-italiana"> Answer : ans</div>
      </div>
    ...
    <button className=" bg-green-500 rounded-2xl mr-10 px-7 py-4 w-32 text-xl">Correct</button>
    <button className="bg-red-500 rounded-2xl mr-10 px-7 py-4 w-32 text-white text-xl">Incorrect</button>
    <button className="bg-custom-brown rounded-2xl mr-10 px-7 py-4 w-32 text-white text-xl">Pass</button>
    </div>
    </div>
  );
};
